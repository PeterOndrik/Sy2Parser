...
# Enumeration TAG T_TM_TestPointsEnum, sizeof(T_TM_TestPointsEnum) is 4 Byte(s):
# Command Type   Name                                                                             Value       Signature
# ---------------------------------------------------------------------------------------------------------------------
RegVar    ENUM   T_TM_TestPointsEnum_TM_NoTestPoint                                               0           UI32
RegVar    ENUM   T_TM_TestPointsEnum_TEEFT_T_TEEFT_enum_tagged_only_TP                            1           UI32
RegVar    ENUM   T_TM_TestPointsEnum_TEEFT_return_Htyp_enum_TP                                    2           UI32
RegVar    ENUM   T_TM_TestPointsEnum_TEEFT_return_Mtyp_enum_TP                                    3           UI32
